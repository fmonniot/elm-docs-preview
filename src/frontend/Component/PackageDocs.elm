...
init : Ctx.ElmPackage -> Maybe String -> ( Model, Cmd Msg )
init package moduleName =
    ( Loading
    , fetchContent package moduleName
    )
...
--
-- TODO Add back anchor support for documentation
--
...
fetchContent : Ctx.ElmPackage -> Maybe String -> Cmd Msg
fetchContent package maybeModuleName =
    case maybeModuleName of
        Nothing ->
            Http.send LoadReadme (Ctx.getReadme package.github)

        Just name ->
            Http.send (LoadDocs name) Ctx.getDocs
